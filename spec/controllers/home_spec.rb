...
describe HomeController, :type => :controller do
  ...
  #the syntax of thsee tests should be familar, it's the same Behavior Driven Development
  #syntax we have seen with the Jasmine javascript testing framework.
  it "should get page for index" do

    #inside the it block is the meat of our tests
    #we use 'get' method to simulate a GET request, asking for the view 'index'

    get :index

    ##expect is an example of how we assert something is true
    #in this case we expect the response from the get to be a success
